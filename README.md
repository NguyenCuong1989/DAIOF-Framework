...
**🏛️ Sovereign Runtime Doctrine**: [Canonical Doctrine](docs/doctrine/sovereign-agentic-runtime.md)  
**🗂️ Connector Registry**: [Registry State](docs/registry/connectors.yml) | [Lifecycle](docs/runtime/connector-lifecycle.md) | [State Machine](docs/runtime/state-machine.md)  
